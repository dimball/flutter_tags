...
class _ItemTagsState extends State<ItemTags> {
  ...
  void _setDataList() {
    ...
    // Guard: if inherited data or list is null, skip setup (can happen during orientation changes)
    ...
    final itemCount = _dataListInherited?.itemCount;
    if (itemCount != null &&
  ...
  Widget build(BuildContext context) {
    ...
    // Guard: if _dataList is null (can happen during orientation changes), show empty
    if (_dataList == null) {
